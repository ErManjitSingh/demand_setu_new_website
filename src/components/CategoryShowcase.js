    ...
    >
      <div className="relative aspect-[3/4] sm:aspect-[4/5]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
          ...
          <span className="mt-4 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-bold text-brand-dark shadow-lg transition group-hover:gap-3">
            Explore collection
